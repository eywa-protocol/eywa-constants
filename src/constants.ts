...
export const BRIDGE_ADDRESS: TChainMapList<string> = {
    ...
    [CHAIN_ID.NETWORK_1]: '0x53C0A09e4954dD2D0edc6bF44F2C53B9c1fED667',
    [CHAIN_ID.NETWORK_2]: '0x0c760E9A85d2E957Dd1E189516b6658CfEcD3985',
    [CHAIN_ID.NETWORK_3]: '0x99A0cc91fb7fbD7b5514D68E9280AFd72576A267',
};
...
export const BRIDGE_ROUTER_ADDRESS: TChainMapList<string> = {
    ...
    [CHAIN_ID.SOLANA_DEVNET]: SolanaAddress.ZERO.toString(),
    [CHAIN_ID.SOLANA_TESTNET]: SolanaAddress.ZERO.toString(),
    [CHAIN_ID.NETWORK_1]: HashZero,
    [CHAIN_ID.NETWORK_2]: HashZero,
    [CHAIN_ID.NETWORK_3]: HashZero,
};
...
export const SYNTHESIZE_ADDRESS: TChainMapList<string> = {
    ...
    [CHAIN_ID.SOLANA_DEVNET]: SolanaAddress.ZERO.toString(),
    [CHAIN_ID.SOLANA_TESTNET]: SolanaAddress.ZERO.toString(),
    [CHAIN_ID.NETWORK_1]: '0xD110733A983A255C692c9547c66266EDE8EAb9d3',
    [CHAIN_ID.NETWORK_2]: '0xdd85dDc3A272000d9d0942eD6e44A2c8c487858e',
    [CHAIN_ID.NETWORK_3]: '0x30c487604FD3c7e8c102EF92EDD3053e24f999E1',
};
...
export const PORTAL_ADDRESS: TChainMapList<string> = {
    ...
    [CHAIN_ID.SOLANA_DEVNET]: SolanaAddress.ZERO.toString(),
    [CHAIN_ID.SOLANA_TESTNET]: SolanaAddress.ZERO.toString(),
    [CHAIN_ID.NETWORK_1]: '0x204F815995eb66B8a13b2308d56CB98d7566F48a',
    [CHAIN_ID.NETWORK_2]: '0xBE8a929Ac944333f054D2936ba7CdcD9A457323f',
    [CHAIN_ID.NETWORK_3]: '0xF5d39537E69D48bfB63A9ecB3fb9D2Ce833cE305',
};
...
export const MULTICALL: TChainMapList<string> = {
    ...
    [CHAIN_ID.SOLANA_DEVNET]: SolanaAddress.ZERO.toString(),
    [CHAIN_ID.SOLANA_TESTNET]: SolanaAddress.ZERO.toString(),
    [CHAIN_ID.NETWORK_1]: '0xdb6FA9f0E6ED3ed588ab6802413062424bC165C5',
    [CHAIN_ID.NETWORK_2]: '0x8d710ae982ab5c7b1dd77063595F659C7827EF63',
    [CHAIN_ID.NETWORK_3]: '0x31c692fc0c7774C7E4F7614EB668dc4bd63D2806',
};
